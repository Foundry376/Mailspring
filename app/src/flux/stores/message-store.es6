...
class MessageStore extends MailspringStore {
  ...
  threadId() { return (this._thread != null ? this._thread.id : undefined); }

  thread() { return this._thread; }
  ...
  */
  ...
  _onApplyFocusChange() {
    ...
    if ((this._thread != null ? this._thread.id : undefined) === (focused != null ? focused.id : undefined)) { return; }
  ...
  _markAsRead() {
    ...
    if (this._thread.unread) {
      ...
      return setTimeout(() => {
        if ((markAsReadId !== (this._thread != null ? this._thread.id : undefined)) || !this._thread.unread) { return; }
  ...
  _fetchFromCache(options) {
    ...
    return query.then(items => {
      ...
      if (loadedThreadId !== (this._thread != null ? this._thread.id : undefined)) { return; }
  ...
  _fetchExpandedAttachments(items) {
    ...
    return (() => {
      ...
      for (let item of items) {
        ...
        result.push(item.files.map((file) =>
